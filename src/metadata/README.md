 ...
 * [bdon.yml](bdon.yml)
     * Determines how your purl.obolibrary.org/obo/bdon/ redirects will be handled
     ...
     * Paste in the contents of [bdon.yml](bdon.yml)
 ...
 * [bdon.md](bdon.md)
     ...
     * Paste in the contents of [bdon.md](bdon.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
